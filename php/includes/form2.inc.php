<form class="container h-100" action="../index.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-center">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <input type="text" class="form-control" placeholder="Prénom" name="firstname" required="required" pattern="[a-z]+">
                    </div>
                    <br>
                    <div class="form-group col-md-6">
                        <input type="text" class="form-control" placeholder="Nom" name="lastname" required="required" pattern="[a-z]+">
                    </div>
                    <br>
                    <div class="form-group col-md-6">
                        <label for="old">Age (18 à 70 ans)</label>
                        <input name="old" type="number" class="form-control" placeholder="Renseignez votre age" min="18" max="70" required="required" pattern="[0-9]+">
                    </div>
                    <br>
    ...
    <section>
        <br>
        <label for="photo"> Joindre une image (jpg ou png)</label><br>
